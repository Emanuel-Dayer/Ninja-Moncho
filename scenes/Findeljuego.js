export default class Findeljuego extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.image(400, 300, 
      (this.victoriaODerrota === "Ganaste" ? "Victoria" : "Derrota")
    ).setDisplaySize(this.scale.width, this.scale.height);


    // Texto de victoria o derrota
    this.add.text(400, 150, this.victoriaODerrota, {
      fontSize: "48px",
    ...
    this.add.text(400, 250, `Puntuación: ${this.puntos}`, {
      fontSize: "32px",
      fill: "#fff",
      stroke: "#000",
      strokeThickness: 8,
    ...
    this.add.text(400, 450, "Presiona ESC para volver al menú", {
      fontSize: "32px",
      fill: "#fff",
      stroke: "#000",
      strokeThickness: 8,
